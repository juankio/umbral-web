<template>
  <section ref="sectionRef" class="relative w-full bg-white py-16 sm:py-20 lg:py-28 overflow-hidden select-none">
    ...
    <!-- Contenedor Maestro -->
    <div class="relative z-10 max-w-[1480px] mx-auto px-6 sm:px-10 lg:px-14">
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-center">
        <!-- Columna Izquierda: Título en 2 Líneas y Manifiesto alineado a la izquierda -->
        <div class="lg:col-span-6 flex flex-col space-y-6 sm:space-y-8">
          <!-- Título en 2 líneas exacto a Figma: Centro Roberto / Garza Sada -->
          <h2 ref="titleRef" class="font-barlow font-normal text-5xl sm:text-6xl lg:text-7xl xl:text-[92px] text-[#1C1C1C] leading-[0.92] tracking-tight text-left">
        ...
        <!-- Columna Derecha: Fotografía limpia con hover interactivo -->
        <div class="lg:col-span-6 flex justify-center lg:justify-end">
          <div
            ref="photoRef"
            class="w-full max-w-[540px] lg:max-w-[600px] xl:max-w-[640px] overflow-hidden shadow-sm hover:shadow-xl transition-all duration-500 ease-out group"
          >
            <AppImage
              src="/images/figma-crgs-section4.webp"
              alt="Centro Roberto Garza Sada - Patio interior y escalinatas de Tadao Ando"
              img-class="w-full aspect-[910/879] object-cover block transition-transform duration-700 ease-out group-hover:scale-[1.03]"
              loading="lazy"
            />
          </div>
        </div>
...
const blueTriangleRef = ref<HTMLElement | null>(null)
...
useParallaxMotion(blueTriangleRef, 0.07, 28)

onMounted(() => {
  observeScrollReveal(blueTriangleRef, { type: 'triangle', delay: 100 })
  observeScrollReveal(titleRef, { type: 'heading', delay: 150 })
  observeScrollReveal(p1Ref, { type: 'paragraph', delay: 220 })
  observeScrollReveal(p2Ref, { type: 'paragraph', delay: 300 })
  observeScrollReveal(photoRef, { type: 'image', delay: 200 })
})
</script>
