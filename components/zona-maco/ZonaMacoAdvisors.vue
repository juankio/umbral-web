  ...
  <section id="asesores" class="py-16 sm:py-24 lg:py-32 bg-white select-none overflow-hidden">
    ...
    <div class="max-w-[1720px] mx-auto px-6 sm:px-12 lg:px-20">
      <div class="pt-4 sm:pt-8">
        <svg
          viewBox="0 0 365 500"
          class="w-32 sm:w-44 lg:w-52 h-auto block transform hover:scale-105 transition-transform duration-700 ease-out"
          fill="none"
          aria-hidden="true"
        >
...
// Frame de Figma 325:2 / Node 348:71 ("Asesores de Proyectos", y: 6728)
</script>
